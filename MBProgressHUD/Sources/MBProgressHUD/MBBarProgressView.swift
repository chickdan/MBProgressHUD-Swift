...
public class MBBarProgressView: UIView {
    ...
    public func draw(_ rect: CGRect) {
        ...
        // Draw background
        makePath(context, radius: radius, rect: rect)
        context.fillPath()
        ...
        if amount >= radius + 4 && amount <= (rect.size.width - radius - 4) {
            drawInMiddleArea(context, radius: radius, amount: amount, rect: rect)
        } else if amount > radius + 4 {
            drawInRightArc(context, radius: radius, amount: amount, rect: rect)
        } else if amount < radius + 4 && amount > 0 {
            drawInLeftArc(context, radius: radius, amount: amount, rect: rect)
        }
    }

    private func makePath(_ context: CGContext, radius: CGFloat, rect: CGRect) {
    ...
    private func drawInMiddleArea(_ context: CGContext, radius: CGFloat, amount: CGFloat, rect: CGRect) {
    ...
    private func drawInRightArc(_ context: CGContext, radius: CGFloat, amount: CGFloat, rect: CGRect) {
    ...
    private func drawInLeftArc(_ context: CGContext, radius: CGFloat, amount: CGFloat, rect: CGRect) {
